...
| `05_dashboard_ui_plan.md`          | **Plan 5 — POC slice.** Dashboard UI and polish, reconciled + split 2026-06-09 into a commit-wise POC (foundation A1/A2/A5 + visuals C1/C2/C4/C7/C11/C12/C15 + tests).                                                                                                                                                                                                                                                              |
| `05_dashboard_ui_plan_deferred.md` | **Plan 5 — deferred remainder.** The post-POC backlog (A3/A4/B1/B2/C3/C6/C8/C9/C10/C13/C14/D1–D5), each with a deferral reason, re-introduction trigger, and acceptance gate. Indexed in `06_dropped_to_simplify.md` §4.                                                                                                                                                                                                                    |
