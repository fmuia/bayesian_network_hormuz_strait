...
| M2  | Soft evidence semantics           | Plan 2 + ~~Plan 3~~ 🅿️                            | A1 (translator-interface facet, ships on discrete path) + ~~Phase 3~~ 🅿️ continuous-node facet parked — see [`06_dropped_to_simplify.md`](06_dropped_to_simplify.md) §2 |
...
| C5  | Soft-evidence mismatch (code side of M2)    | Plan 2 + ~~Plan 3~~ 🅿️ | A1 (closes the discrete code side) + ~~Phase 3~~ 🅿️ — see [`06_dropped_to_simplify.md`](06_dropped_to_simplify.md) §2 |
...
| `02_translator_robustification_commit_plan.md` | **Plan 2 — execution companion.** Commit-by-commit decomposition (T01–T13 + riders) with per-commit acceptance gates, a dependency graph, and an "Open decisions & risks" section. The *how/when* to Plan 2's *why*.                                                                                                                                                                                                                                                                                              |
